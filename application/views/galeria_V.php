...
<div style="width: 90%; margin: 5% auto">
	...
	<div class="cont_galeria" id="Cont_galeria">
		<div class="cont_Galeria--item">
			<img class="cont_Galeria--img" id="DSC_9538-45" src="<?php echo base_url();?>assets/images/DSC_9538-45.jpg"/>
		</div>
		<div class="cont_Galeria--item">
...
<script src="<?php echo base_url();?>assets/javascript/E_Galeria.js?v=<?php echo rand();?>"></script> 
